...
func AddVsToSnap(snap *gwv1.ApiSnapshot, us *core.ResourceRef, namespace string) *gwv1.ApiSnapshot {
	return AddNamedVsToSnap(snap, us, "secondary-vs", namespace)
}

func AddNamedVsToSnap(snap *gwv1.ApiSnapshot, us *core.ResourceRef, name, namespace string) *gwv1.ApiSnapshot {
